...
# device
$(call inherit-product-if-exists, device/samsung/t0lte/full_t0lte.mk)
...
PRODUCT_NAME := ukg_t0lte
PRODUCT_MODEL := GT-N7105
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.t0lte.$(shell date +%m%d%y).$(shell date +%H%M%S)
